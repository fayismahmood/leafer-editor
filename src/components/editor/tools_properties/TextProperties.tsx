...
import { Section, NumberField, SelectField, ToggleField } from './fields'
...
export function TextProperties() {
  ...
  const [verticalAlign, setVerticalAlign] = useState<string>(el?.verticalAlign ?? 'top')
  const [textCase, setTextCase] = useState<string>(el?.textCase ?? 'none')
  const [textDecoration, setTextDecoration] = useState<string>(el?.textDecoration ?? 'none')
